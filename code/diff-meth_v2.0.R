...
load("code/methBase_preliminary_v2.0.RData")
...
save(myDiff, file = "code/myDiff_diff-meth_v2.0.RData")
...
save(list = c("myDiff", "myDiff_df"), file = "code/myDiff_diff-meth_v2.0.RData"))