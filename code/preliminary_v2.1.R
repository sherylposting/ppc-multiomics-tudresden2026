...
# filtered: discard cpg that have <4x coverage or >30x
filtered.methRawList <- filterByCoverage(omitted.methRawList,lo.count=4,lo.perc=NULL,
...
save(prefilt_summary, postfilt_summary, filt_df, file = "code/filt-summarydf_preliminary_v2.1.RData")
...
save(methNormList.dfList, methRawList.dfList, methFiltList.dfList, file = "code/methRawList-dfs_preliminary_v2.1.RData")
...
save(methBase, file = "code/methBase_preliminary_v2.1.RData")
...
ggsave(
  filename = "results/pca-plot_preliminary_v2.1.pdf",
  plot = pca_plot,
  width = 8,
  height = 6,
  units = "in"
